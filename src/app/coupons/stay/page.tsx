...
export default function StayCouponPage(){
  ...
  return <main className="coupon-page"><div><p>まちやど公式予約者限定</p><h1>滞在中クーポン</h1><p>{period}</p>{state==="active"?<><h2>ご利用いただけます</h2><p>対象店舗で4,000円以上のご飲食時に500円引き。</p></>:state==="before"?<h2>このクーポンはまだ利用期間前です</h2>:state==="expired"?<h2>このクーポンの利用期間は終了しました</h2>:<h2>このアカウントではクーポンを利用できません</h2>}</div></main>;
}
